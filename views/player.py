...
class PlayerView:
    ...
    def prompt_player_lastname(self) -> str:
        ...
        confirm = ""
        while confirm != "Y":
            last_name = input(Fore.LIGHTCYAN_EX +
                              "entrez le nom du joueur : ").capitalize()
            if not last_name:
                print(Fore.LIGHTRED_EX + "Je n'ai pas compris ce que vous voulez dire, "
                      "veuillez entrer un nom svp")
            else:
                print(Fore.LIGHTGREEN_EX +
                      f"Le nom du joueur est : {last_name}")
    ...
    def prompt_player_firstname(self) -> str:
        ...
        confirm = ""
        while confirm != "Y":
            first_name = input(Fore.LIGHTCYAN_EX +
                               "entrez le prénom du joueur : ").capitalize()
            if not first_name:
                print(Fore.LIGHTRED_EX + "Je n'ai pas compris ce que vous voulez dire, "
                      "veuillez entrer un prénom svp")
            else:
                print(Fore.LIGHTGREEN_EX +
                      f"Le prénom du joueur est : {first_name}")
                while confirm != "Y" or "N":
                    confirm = input(Fore.LIGHTCYAN_EX +
                                    "Vous confirmez ? (Y/N) : ").upper()
                    if confirm == "Y":
    ...
    def prompt_player_birthdate(self) -> str:
        ...
        confirm = ""
        while confirm != "Y":
            birth_date = input(Fore.LIGHTCYAN_EX +
            ...
            if not birth_date:
                ...
                print(Fore.LIGHTGREEN_EX +
                      f"Le nom du joueur est : {birth_date}")
                while confirm != "Y" or "N":
                    confirm = input(Fore.LIGHTCYAN_EX +
                                    "Vous confirmez ? (Y/N) : ").upper()
                    if confirm == "Y":
    ...
    def prompt_player_elo(self) -> int:
        ...
        while confirm != "Y":
            ...
            if not elo.isnumeric() or not elo:
                ...
                print(Fore.LIGHTGREEN_EX +
                      f"Le classement elo du joueur est: {elo}")
                while confirm != "Y" or "N":
                    confirm = input(Fore.LIGHTCYAN_EX +
                                    "Vous confirmez ? (Y/N) : ").upper()
                    if confirm == "Y":
